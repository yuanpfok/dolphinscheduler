...
import { useReUpload } from './use-reupload'
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const handleFile = () => {
      handleReUploadFile(ctx.emit, hideModal, resetForm)
    }
  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={t('resource.file.re_upload')}
